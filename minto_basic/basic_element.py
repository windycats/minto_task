...
class minto_element():
    ...
    def choose_tasktype(self, type_text,task_type):
        ...
        act.move_to_element(self.wd.find_element_by_xpath('//div[contains(text(),"' + type_text + '")]')).perform() #选择任务管理
        sleep(1)
    ...
    def choose_time(self, input_time):
        ...
        self.wd.find_element_by_xpath('//*[@show_type="date"]').click()
        self.wd.switch_to.default_content()
    ...
    def basic_info(self, title, choosetime, member, mubiao=None, xieban=None, leader=None, unit=None):
        ...
        self.wd.find_element_by_xpath('//input[@d_c="2"]').click()  # 点击承办单位的框框
        self.wd.switch_to.default_content()
